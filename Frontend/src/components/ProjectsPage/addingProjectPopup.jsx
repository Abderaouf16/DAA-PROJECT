...
export default function AddingProjectPopup(props) {
  const { togglePopup, handleAddProject, projectName, setProjectName, description, setDescription } = props;
...
<form action="" className='   '>
  ...
  <input
   onChange={(e) => {
     ...
     type="file" name="fileToUpload" id="fileToUpload" class=" p-2 rounded-md  ml-4 text-sm w-10/12 " required/>         
  </div>
