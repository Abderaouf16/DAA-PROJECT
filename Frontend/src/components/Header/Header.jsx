...
<>
   <header>
    ...
    <nav className='nav flex items-center justify-around py-10 bg-white w-full'>
            ...
            <li className='text-black'><a href="/profile">profile</a></li>
                {!user && (
                 <>
                   ...
                   <li className= ' signupBtn text-white border-2 rounded-md border-black px-7 py-2 z-50'><a href="/signup">Signup</a></li>
                 </>
        ...
        {user && ( 
           <>
            <div ref={dropdownRef} className="pofileSection flex gap-2 border border-grey-300 rounded-full py-2 px-4 bg-white p-2">
        ...
        <div className=" px-4 flex justify-center items-center  ">
           <h2 className='text-white text-md font-bold  '>{user.username}</h2>
        </div>
