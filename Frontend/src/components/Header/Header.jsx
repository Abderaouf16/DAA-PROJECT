...
<>
    ...
    <nav className='nav flex items-center justify-around p-10  bg-white'>
        <a className= 'text-black title   font-bold ' href='/home'> Archi World</a>
            ...
            <li className='text-black'><a href="/projects">Projects</a></li>
                {!user && (
                 <>
                   ...
                   <li className='text-black border-2 border-black px-7 py-2 z-50'><a href="/signup">Signup</a></li>
                 </>
      ...
      <svg onClick={handdelSideBar} className='hamborger ' xmlns="http://www.w3.org/2000/svg" width="32" height="32"><g fill="none" fill-rule="evenodd"><path fill="#FFF" stroke="#2C2830" stroke-width="1.5" d="M.75.75h30.5v30.5H.75z"/><g fill="#2C2830"><path d="M8 10h16v1.5H8zM8 15h16v1.5H8zM8 20h16v1.5H8z"/></g></g></svg>
    </nav> 
 </>
  )
}
