...
export default function Signup2() {
  ...
  <section>
   ...
   <div className="  w-11/12 h-full flex justify-center items-center father_container ">
    <div className=" container-left2_Signup ">
    </div>
    <div className=" bg-white w-11/12 h-full  rounded-2xl flex container-right2">
    <div className="    ">
      <h2 className='_h2 flex  justify-center py-4 '> Join Us</h2>
      <div className="big container  ">
           ...
           <div className="email">
            <div className="">
                  <label htmlFor="" className='flex m-2 '>
                    <span className='flex text-email  text-md text-black m-2 px-2  '> Add your email:</span>
                  </label>
           ...
           <div className="pasword">
            <div className="">
              <label htmlFor="" className='flex text-email text-md text-black m-2'>
                <span className='flex text-email  text-md text-black m-2 px-2 '> Choose a password:</span>
              </label>
            </div>
            <div className=" flex flex-row m-1  justify-center ">
        ...
        <div className="  p-5">
        <h4 className='text-black text-xs '>By joining in to Archi-World, I confirm that I have read and agree to the Archi-World Terms of Service, Privacy Policy, and to receive emails and updates.</h4>
